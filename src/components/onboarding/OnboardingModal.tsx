  ...
  const steps = [
    {
      ...
      icon: <Heart className="w-16 h-16 text-[#4C9F70]" />
    },
    {
      ...
      icon: <Package className="w-16 h-16 text-[#4C9F70]" />
    },
    {
      ...
      icon: <FileText className="w-16 h-16 text-[#4C9F70]" />
    },
    {
      ...
      icon: <Store className="w-16 h-16 text-[#4C9F70]" />,
      children: (
    ...
    <Dialog open={showOnboarding} onOpenChange={() => {}}>
      <DialogContent className="max-w-2xl p-0 overflow-hidden">
        <div className="relative">
          ...
          {/* Step content */}
          <div className="bg-gradient-to-br from-green-50 to-white min-h-[500px]">
            <OnboardingStep
          ...
          <div className="flex items-center justify-between p-6 border-t bg-white">
            ...
            <Button
              onClick={handleNext}
              className="bg-[#4C9F70] hover:bg-[#3d8159] flex items-center"
            >
