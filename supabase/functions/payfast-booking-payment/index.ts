...
serve(async (req) => {
  ...
  try {
    ...
    const paymentData = {
      ...
      return_url: `https://link2pay.co.za/booking-payment-success?booking_id=${bookingId}`,
      cancel_url: `https://link2pay.co.za/booking-payment-cancelled?booking_id=${bookingId}`,
